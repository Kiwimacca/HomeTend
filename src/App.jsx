    ...
    <div className="page">
      ...
      <section className="above-fold">
        ...
        <div className="fold-pane fold-pane-hero">
          ...
          <p style={{ fontSize: 14, color: '#4A5048', lineHeight: 1.6, marginTop: 8, marginBottom: 20 }}>Maintaining your home has never been easier. Choose your services bundle, pay 50% now and spread the rest across easy monthly payments.</p>

...
const SERVICES = [
  { id: 'house-wash', name: 'House Wash', angle: 0, maxFrequency: 'twice-yearly',
    ...
    marketRate: 'One-off in Christchurch: $275 – $950+' },
  { id: 'roof', name: 'Roof Treatment', angle: 45, maxFrequency: 'twice-yearly',
    ...
    marketRate: 'One-off in Christchurch: $375 – $950+' },
    ...
    <div className="page">
      ...
      <section className="above-fold">
        ...
        <div className="fold-pane fold-pane-hero">
          ...
          <p style={{ fontFamily: "'Inter', sans-serif", fontSize: 14, color: '#4A5048', lineHeight: 1.6, marginTop: 0, marginBottom: 24 }}>Maintaining your home has never been easier. Choose your services bundle, pay 50% now and spread the rest across easy monthly payments.</p>
